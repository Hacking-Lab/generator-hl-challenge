# Ubuntu 18 Linux NGINX Web Server
## Introduction
This content ist provided by a Ubuntu 18 Linux nginx web server (docker) from the Hacking-Lab CTF system. 
